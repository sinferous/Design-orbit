...
- [x] **Navbar & Header Polish**:
  ...
  - Redesigned the Navbar brand header in [`Navbar.tsx`](file:///j:/Work/Webtree%20Online/Design%20orbit/src/components/layout/Navbar.tsx): removed the corporate Webtree logo and vertical divider pipe, and transformed the brand typography into an animated ligature: **Design** + miniature animated dotted orbit (with center glowing core and 2 revolving colored satellite circles) replacing the letter **'O'**, followed by **'rbit'** in clean, bold text.
