  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/75 backdrop-blur-md flex items-center justify-center p-3 sm:p-4">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative bg-slate-900 rounded-2xl border border-slate-700 shadow-2xl shadow-black/80 max-w-2xl w-full p-4 sm:p-6 space-y-4 animate-in fade-in zoom-in-95 duration-150 z-10 max-h-[92vh] overflow-y-auto text-slate-100">
