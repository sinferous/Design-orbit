      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="bg-slate-900 p-6 rounded-xl border border-slate-800 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <Link
            ...
            className="inline-flex items-center space-x-2 px-4 py-2 text-sm font-bold text-slate-300 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-lg transition-colors cursor-pointer"
          >
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                {profile?.designation && (
                  <span className="text-xs font-semibold text-slate-300 bg-slate-800 border border-slate-700 px-2.5 py-0.5 rounded-md">
                    {profile.designation}
                  </span>
                )}
              </div>
              <p className="text-xs text-slate-400 mt-1">{currentUser.email || 'varun@webtreeonline.com'}</p>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handlePasswordChange} className="space-y-4 max-w-md">
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={updating}
                className="inline-flex justify-center items-center space-x-2 px-6 py-2.5 text-sm font-bold text-white webtree-gradient-btn rounded-lg shadow-sm disabled:opacity-50 cursor-pointer"
              >
